...
public class Sentencias {
    ...
    public void guardar(Connection conexion, Tareas tarea) throws SQLException{
        try{
   ...
   public Tareas recuperarPorId(Connection conexion, int id_tarea) throws SQLException {
      Tareas tarea = null;
      try{
         ...
         while(resultado.next()){
            tarea = new Tareas(id_tarea, resultado.getString("titulo"), resultado.getString("descripcion"), resultado.getInt("nivel_de_prioridad"));
         }
      }catch(SQLException ex){
         throw new SQLException(ex);
      }
   ...
   public void eliminar(Connection conexion, Tareas tarea) throws SQLException{
      try{
   ...
   public List<Tareas> recuperarTodas(Connection conexion) throws SQLException{
      ...
      try{
         ...
         ResultSet resultado = consulta.executeQuery();
         while(resultado.next()){
            tareas.add(new Tareas(resultado.getInt("id_tarea"), resultado.getString("titulo"), resultado.getString("descripcion"), resultado.getInt("nivel_de_prioridad")));
         }
      }catch(SQLException ex){
         throw new SQLException(ex);
      }
